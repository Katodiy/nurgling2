...
public class GameUI extends ConsoleHost implements Console.Directory, UI.Notice.Handler {
	...
	public MainMenu() {
		...
		// TODO убрать отсюда
		prev = add(new MenuCheckBox("rbtn/opt/", kb_routes, "Game Settings"), prev.pos("ur").add(UI.scale(10),0)).state(() -> wndstate(NUtils.getGameUI().nsw)).click(() ->{if(NUtils.getGameUI()!=null) togglewnd(NUtils.getGameUI().nsw);});

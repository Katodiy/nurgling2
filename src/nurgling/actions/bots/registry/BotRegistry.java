...
import nurgling.actions.ItemNameCheck;
...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("bed", BotDescriptor.BotType.UTILS, "Go to bed", "Go to any free bed in a bed area nearby.", false, true, ItemNameCheck.class, "bed", false));

...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("study_desk_filler", BotDescriptor.BotType.UTILS, "Fill study desk", "Fill study desk", true, true, StudyDeskFiller.class, "travellerssack", false));

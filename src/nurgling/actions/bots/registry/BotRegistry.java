...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("bed", BotDescriptor.BotType.UTILS, "Catch moths", "Go to any free bed in a bed area nearby.", false, true, CatchBugsAround.class, "bed", false));

...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("trellis", BotDescriptor.BotType.BUILD, "Build Trellis", "Builds trellis (3 blocks + 1 string each, builds 3 per tile).", false, true, BuildTrellis.class, "build", false));

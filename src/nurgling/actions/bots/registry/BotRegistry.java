...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("forager", BotDescriptor.BotType.RESOURCES, "Forager", "Smokes out wild beehives and collects honey. Automatically reacts to dangerous animals and unknown players.", false, true, Forager.class, "forager", false));

...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("grape", BotDescriptor.BotType.FARMING, "Grape Farmer", "Automatically harvests grapes from trellis.", true, true, GrapeFarmer.class, "test40", false));

...
public class YellowOnionFarmer implements Action {
    ...
    public Results run(NGameUI gui) throws InterruptedException {
        ...
        NArea yellowOnion = NContext.findOut("Yellow Onion", 1);
        NArea yellowOnionAsSeed = NContext.findIn("Yellow Onion");
        ...
        if(new Validator(req, opt).run(gui).IsSuccess())
        {
            ...
            new SeedCrop(NContext.findSpec(field),yellowOnionAsSeed,new NAlias("plants/yellowonion"),new NAlias("Yellow Onion"), true).run(gui);
        }

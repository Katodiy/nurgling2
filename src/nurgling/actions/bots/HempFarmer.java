...
public class HempFarmer implements Action {
    ...
    public Results run(NGameUI gui) throws InterruptedException {
        ...
        {
            new HarvestCrop(NContext.findSpec(field), NContext.findSpec(seed),NContext.findSpec(trough),NContext.findSpec(swill),new NAlias("plants/hemp"),new NAlias("Hemp"),4, false).run(gui);

...
public class SpecialisationData {
    ...
    static
    {
        ArrayList<String> crops = new ArrayList<>(Arrays.asList("Flax", "Turnip", "Carrot", "Hemp", "Millet", "Wheat", "Barley", "Poppy", "Beetroot", "Red Onion", "Yellow Onion", "Garlic", "Pipeweed", "Lettuce"));
        data.put("crop",crops);
        data.put("seed",crops);
